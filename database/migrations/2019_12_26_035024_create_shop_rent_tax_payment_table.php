...
class CreateShopRentTaxPaymentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('shop_rent_tax_payment', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('shop_rent_tax_payment');
    }
}
