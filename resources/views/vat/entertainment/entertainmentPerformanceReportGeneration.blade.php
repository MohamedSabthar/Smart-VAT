    ...
    <div class="col">
        ...
        <div class="card shadow">
            <div class="card-header bg-transparent">
                <h3 class="mb-0"><span class="text-uppercase">{{__('menu.Generate Entertainment Performance payments Report')}}</span>
                </h3>
            </div>
            ...
            <div class="card-body ">
                ...
                <form method="POST" action="{{route('entertainment-performance-report-view')}}">
                    @csrf
