    ...
    <div class="col">
        <div class="card shadow">
            <div class="card-header bg-transparent">
                <h3 class="mb-0 text-center"><span class="text-uppercase">Advertisement Tax Report from
            ...
            <table id="business_tax_report" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">Rs. {{ number_format($record->final_payment, 2) }}</td>
            ...
            <form method="POST" action="{{route('advertisement-tax-report-pdf')}}" class="d-none" id="dates">
                @csrf
