...
<div class="col-xl-3 col-lg-6"
    onclick="javascript:window.open(`{{route('booking-trash-payment',['id'=>$bookingTax->payer->id])}}`,'_self')"
...
<div class="pt-5">
    <div class="row">
            ...
            <div class="card card-profile shadow">
                ...
                <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                    <div class="d-flex justify-content-between">
                        <a href="{{route('booking-profile',['id'=>$bookingTax->payer->id])}}"
                ...
                <div class="card-body pt-0 pt-md-4">
                    <div class="test-left pt-5">
                        ...
                        {{ucwords($bookingTax->shop_name)}}
                        <div class="pt-1">
                            <h3 class="d-inline">{{__('menu.Address')}} : </h3> {{ucwords($bookingTax->address)}}
                        </div>

                        <div class="pt-1">
                            <h3 class="d-inline">{{__('menu.Assesment No.')}} : </h3>
                            {{$bookingTax->registration_no}}
                        </div>
                        ...
                        <div class="pt-1">
                            ...
                            {{number_format($bookingTax->anual_worth,2)}}
                        </div>
                        <hr>

                        <div class="pt-1">
                            <h3 class="d-inline">{{__('menu.Phone No')}} : </h3> {{$bookingTax->phone}}
                        </div>
        ...
        <div class="col-xl-8 order-xl-1">
            ...
            {{-- payment form --}}
            <form action="{{route('receive-booking-payments',['shop_id'=>$bookingTax->id])}}"
                ...
                <div class="table-responsive py-4">
                    ...
                    <table id="industrial_payments_table" class="table  px-5">
                        ...
                        <tbody>
                            ...
                            @foreach ($bookingTax->payments as $payments)
                            <tr>
                                <td>{{$payments->id}}</td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <form id="remove-payment"
                                                action="{{route('remove-booking-payment',['id'=>$payments->id])}}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
