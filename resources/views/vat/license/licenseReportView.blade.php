...
@section('title','License report View')
@push('css')
    ...
    <div class="col">
        <div class="card shadow">
            <div class="card-header bg-transparent">
                <h3 class="mb-0 text-center"><span class="text-uppercase">License Duty Report from {{ $dates->startDate }} to {{ $dates->endDate }}</span></h3>
            </div>
            <table id="business_tax_report" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td >{{ $record->shop_id."-".$record->licenseTaxShop->shop_name}}</td>
            ...
            <form method="POST" action="{{route('license-tax-report-pdf')}}" class="d-none" id="dates">
                @csrf
