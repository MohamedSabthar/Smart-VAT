...
<div class="col mt-5">
	...
	<div class="alert alert-primary alert-dismissible fade show col-8 mb-5" role="alert">
		...
		<span class="alert-inner--text mx-2">
			Click here to add License Duty
			<a href="#" class="btn btn-sm btn-success mx-4 add-buissness">{{__('menu.[+] License')}}</a>
...
<div class="row ">
		...
		<div class="card card-profile shadow">
			...
			<div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
				<div class="d-flex justify-content-between">
					<a href="#" class="btn btn-sm btn-success mr-4 add-buissness">{{__('menu.[+] License')}}</a>
				</div>
			</div>
	...
	<div class="col-xl-8 order-xl-1">
		<div class="card bg-secondary shadow mb-5 hide" id="license-registration">
			<div class="card-header bg-white border-0">
				<div class="row align-items-center">
					<div class="col-8">
						<h3 class="mb-0"><span class="text-uppercase">{{__('menu.Add License Duty')}}</span></h3>
					</div>

				</div>
			</div>
			<div class="card-body">
				{{-- LIcense Tax duty registration form --}}
				<form method="POST" action="{{route('license-duty-register',['id'=> $vatPayer->id])}}"   {{-- -*** --}}
					id="license-duty-register">
					@csrf
					...
					<div class="form-group row">
						<label for="industrial-type"
							class="col-md-2 col-form-label form-control-label ">{{__('menu.License type')}}</label>
						<div class="col-md-10">

							<select id="type" name="type" class="form-control @error('type') is-invalid  @enderror">
								<option value=""></option>
								{{-- only for testing need to implement Ajax searchLicense --}}
							...
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" id="redirect" class="btn  btn-primary ml-auto"
										onclick="javascript:document.getElementById('license-duty-register').submit();">{{__('menu.Confirm')}}</button>
								</div>
				...
				{{-- end of LIcense tax duty registration form --}}
			</div>
		</div>
		...
		<div class="card shadow">
					...
					<div class="col">
						<h3 class="mb-0">
							<span class="text-uppercase">{{$vatPayer->first_name}}
								'{{__('menu.s License Tax shops')}}</span>
						</h3>
						<hr class="mt-4 mb-0">
					</div>
				</div>
			...
			<div class="card-body">
				<div class="table-responsive">
					{{-- License Tax Duty Table --}}
					<table id="license_tax_table" class="table">
						...
						<thead id="search_inputs">
							<tr>
								...
								<th><input type="text" class="form-control form-control-sm" id="seachLicenseTax"
								...
								<td class="text-right">
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
											...
											<form
												action="{{route('remove-inudstrial-shop',['shop_id'=>$license->id])}}"
												method="POST">
												@csrf
												@method('delete')
												<input type="submit" value="{{__('menu.Remove License')}}"
													class="dropdown-item">
											</form>
										</div>
...
<script>
	$(document).ready(function() {
        ...
        var id = '#license_tax_table';                      //data table id
        ...
        $('#seachLicenseTax').on( 'keyup', function () { 
            table
                .columns( 1 )
                .search( this.value )
                .draw();
