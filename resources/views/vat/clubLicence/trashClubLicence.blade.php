...
@section('title','Trash Club Licence')
        ...
        <div class="card shadow">
            <div class="card-header bg-white border-0">
                <div class="row align-item-center">
                    <div class="col">
                        <h3 class="mb-0">
                            <span class="text-uppercase">{{__('menu.Trash Club Licence')}}</span>
                        </h3>
                        <hr class="mt-4 mb-0">
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="trash_business" class="table">
                        ...
                        <thead id="search_inputs">
                            <tr>
                                ...
                                <th><input type="text" class="form-control form-control-sm" id="searchBuisness"
                                        placeholder="{{__('menu.Search Club Licence Name')}}" />
                                </th>
                        ...
                        <tbody>
                            @foreach ($licenceTaxClub as $clubLicence)
                            <tr>
                                <td>{{$clubLicence->id}}</td>
