...
@section('title','Trash Land Premises')
        ...
        <div class="card shadow">
            <div class="card-header bg-white border-0">
                <div class="row align-item-center">
                    <div class="col">
                        <h3 class="mb-0">
                            <span class="text-uppercase">{{__('menu.Trash Land Premises')}}</span>
                        </h3>
                        <hr class="mt-4 mb-0">
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="trash_industrial" class="table">
                        ...
                        <thead id="search_inputs">
                            <tr>
                                ...
                                <th><input type="text" class="form-control form-control-sm" id="searchPremises"
                                        placeholder="{{__('menu.Search Land')}}" />
                                </th>
                        ...
                        <tbody>
                            @foreach ($landTaxPremises as $premises)
                            <tr>
                                <td>{{$premises->id}}</td>
                                <td>{{$premises->land_name}}</td>
                                <td>{{$premises->phone}}</td>

                                <td>
                                    <a class="btn btn-outline-success btn-sm "
                                        href="{{route('restore-land-premises',['id'=>$premises->id])}}">
                                        {{__('menu.Restore')}}</a>
                                </td>
