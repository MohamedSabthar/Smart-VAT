	...
	<div class="col">
		...
		<div class="card shadow">
			<div class="card-header bg-white border-0">
				<div class="row align-items-center">
					<div class="col-6 card-header">
						<h3 class="mb-0 d-inline pr-2">Permanent Slaugherting Tax Payers</h3>
					</div>
					<div class="col-6 text-right">
						<button class="btn btn-sm btn-icon btn-3 btn-success text-white" data-toggle="tooltip"
							...
							onclick="javascript:window.open('{{route('payer-registration',['requestFrom'=>'slaughtering'])}}','_self')">
			...
			<div class="table-responsive py-4">
				{{-- Slaughtering VAT payers table --}}
				<table id="license_payer_table" class="table  px-5">
				...
				{{-- end of license VAT payers table --}}
			</div>
		</div>
	</div>
</div>

{{-- Temperally Slaughtering Vat Payers --}}
<div class="row">
	<div class="col">
		...
		<div class="card shadow">
			<div class="card-header bg-white border-0">
				<div class="row align-items-center">
					<div class="col-6 card-header">
						<h3 class="mb-0 d-inline pr-2">Temperally Slaugherting Tax Payers</h3>
					</div>
					<div class="col-6 text-right">
						<button class="btn btn-sm btn-icon btn-3 btn-success text-white" data-toggle="tooltip"
							data-placement="right" title="Click to register new VAT Payer"
			...
			<div class="table-responsive py-4">
				...
				{{-- end of Temperally Slaughtering VAT payers table --}}
			</div>
		</div>
	</div>
</div>
...
{{-- Slaughtering on special occations --}}
<div class="row">
	<div class="col">
		...
		<div class="card shadow">
			<div class="card-header bg-white border-0">
				<div class="row align-items-center">
					<div class="col-6 card-header">
						<h3 class="mb-0 d-inline pr-2">Special occations Slaugherting Tax Payers</h3>
					</div>
					<div class="col-6 text-right">
						<button class="btn btn-sm btn-icon btn-3 btn-success text-white" data-toggle="tooltip"
							data-placement="right" title="Click to register new VAT Payer"
...
<script>
	$(document).ready(function() {
        ...
        var id = '#license_payer_table';                      //data table id
