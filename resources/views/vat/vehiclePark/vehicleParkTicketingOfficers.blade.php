	...
	<div class="col">
		...
		<div class="card shadow">
			<div class="card-header bg-white border-0">
				<div class="row align-items-center">
					<div class="col-6 card-header">
						<h3 class="mb-0 d-inline pr-2">Vehicle Park Ticketing officers</h3>
					</div>
					<div class="col-6 text-right">
						<button class="btn btn-sm btn-icon btn-3 btn-success text-white" data-toggle="tooltip"
							data-placement="right" title="Click to register new Ticketing officers"
			...
			<div class="table-responsive py-4">
				{{-- Vehicle Tax ticketing officer table --}}
				<table id="business_payer_table" class="table  px-5">
					<thead class="thead-light">
						<tr>
							<th>{{__('menu.User ID')}}</th>
							<th>{{__('menu.Ticketing Officer Name')}}</th>
					...
					<thead id="search_inputs">   
						<tr>
                            ...
                            <th></th>
                            <th><input type="text" class="form-control form-control-sm" id="searchNIC"
                                placeholder="{{__('menu.Search NIC')}}" /></th>
							@if (Auth::user()->role=='admin')
				...
				{{-- end of Vehicle Tax ticketing officers table --}}
			</div>
		</div>
	</div>
</div>
