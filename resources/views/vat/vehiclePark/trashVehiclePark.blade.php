...
@section('title','Trash Vehicle Park')
        ...
        <div class="card shadow">
            <div class="card-header bg-white border-0">
                <div class="row align-item-center">
                    <div class="col">
                        <h3 class="mb-0">
                            <span class="text-uppercase">{{__('menu.Trash Vehicle Park')}}</span>
                        </h3>
                        <hr class="mt-4 mb-0">
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="trash_vehicle_park" class="table">
                        <thead class="thead-light">
                            <tr>

                                <th>{{__('menu.Assesment No.')}}</th>
                                <th>{{__('menu.Vehicle Park Name')}}</th>
                                <th>{{__('menu.Phone')}}</th>
                        ...
                        <tbody>
                            @foreach ($vehicleParkTax as $vehiclePark)
                            <tr>
                                <td>{{$vehiclePark->id}}</td>
                                <td>{{$vehiclePark->park_name}}</td>
                                <td>{{$vehiclePark->phone}}</td>

                                <td>
                                    <a class="btn btn-outline-success btn-sm "
                                        href="{{route('restore-business',['id'=>$vehiclePark->id])}}">
                                        {{__('menu.Restore')}}</a>
                                </td>
