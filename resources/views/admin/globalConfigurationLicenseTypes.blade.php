...
<div class="col-11 m-3 card shadow">
    <div class="card-header bg-transparent">
        <h3 class="mb-0"><span class="text-uppercase">Add new License Type</span></h3>
    </div>

    <div class="card-body bg-secondary ">
        <form method="POST" action="{{route('add-license-type',['id'=>$assessmentRange->id])}}"
            id="add-license-type">
            @csrf
            ...
            <div class="row">
                ...
                <div class="form-group row col-12 ">
                    ...
                    <input type="submit" value="Add" class="btn btn-primary col-md-2 mx-3 mt-3 mt-md-0"
                        onclick="javascript:event.preventDefault()" data-target="#confirm-add-license-type"
                        data-toggle="modal">
                </div>
            ...
            <div class=" modal fade" id="confirm-add-license-type" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Are you sure? Do you wish to Add this License type?<br></p>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn  btn-primary ml-auto"
                                onclick="javascript:document.getElementById('add-license-type').submit();">{{__('menu.Yes')}}</button>
                        </div>
...
<div class="col-11 m-3 card shadow" id="update-type-card">
    <div class="card-header bg-transparent">
        <h3 class="mb-0"><span class="text-uppercase">Update License Type</span></h3>
    </div>
                ...
                <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Are you sure? Do you wish to update this License type?<br></p>
                        </div>
        ...
        <div class="card shadow">
            <div class="card-header bg-white border-0">
                <div class="row align-item-center">
                    <div class="col">
                        <h3 class="mb-0">
                            <span class="text-uppercase">{{__('menu.License Range Types')}}</span>
                        </h3>
                        <hr class="mt-4 mb-0">
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="trash_payment" class="table">
                        ...
                        <tbody>
                            @foreach ($assessmentRange->licenseRangeTypes as $type)
                            <tr>
                                <td>{{$type->id}}</td>
