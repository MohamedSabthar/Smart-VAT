...
<div class="col-11 m-3 card shadow ">
    <div class="card-header bg-transparent">
        <h3 class="mb-0"><span class="text-uppercase">Update Advertisement Tax</span></h3>
    </div>

    <div class="card-body bg-secondary ">


        <form method="POST" action="{{route('update-advertisement-percentage')}}" id="update-advertisement-details">
            @csrf
            @method('put')
            <div class="row">
                <div class="form-group row col-12 ">
                    <label for="example-text-input" class="col-md-2 col-form-label form-control-label ">
                        Advertisement Tax percentage </label>
                    <div class="col-md-7">

                        <input type="text" class="form-control  d-inline @error('vatPercentage') is-invalid @enderror"
                            id="vatPercentage" name="vatPercentage"
                            value="{{old('vatPercentage',number_format($advertisementTaxPayment->vat_percentage,2))}}"
                ...
                {{-- <div class="form-group row col-12 ">
                    ...
                    <div class="col-md-7">
                        ...
                        <input type="date" class="form-control  d-inline @error('dueDate') is-invalid @enderror"
                            id="dueDate" name="dueDate" value="{{old('dueDate',$advertisementTaxPayment->due_date)}}"
                    ...
                    <input type="submit" id="register" value="Update" class="btn btn-primary col-md-2 mx-3 mt-3 mt-md-0"
                        onclick="javascript:event.preventDefault()" data-target="#confirm-update-advertisement"
                        data-toggle="modal">
                </div>
            ...
            <div class=" modal fade" id="confirm-update-advertisement" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Are you sure you wish to update Advertisement Tax details ?<br></p>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="redirect" class="btn  btn-primary ml-auto"
                                onclick="javascript:document.getElementById('update-advertisement-details').submit();">{{__('menu.Yes')}}</button>
                        </div>
