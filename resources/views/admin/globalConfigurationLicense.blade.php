...
<div class="col-11 m-3 card shadow ">
    <div class="card-header bg-transparent">
        <h3 class="mb-0"><span class="text-uppercase">Update License Tax</span></h3>
    </div>

    <div class="card-body bg-secondary ">


        <form method="POST" action="{{route('update-license-percentage')}}" id="update-license-details">
            @csrf
            @method('put')
            <div class="row">
                <div class="form-group row col-12 ">
                    <label for="example-text-input" class="col-md-2 col-form-label form-control-label ">
                        License Tax percentage </label>
                    <div class="col-md-7">

                        <input type="text" class="form-control  d-inline @error('vatPercentage') is-invalid @enderror"
                            id="vatPercentage" name="vatPercentage"
                            value="{{old('vatPercentage',number_format($license->vat_percentage,2))}}"
                ...
                <div class="form-group row col-12 ">
                    <label for="example-text-input" class="col-md-2 col-form-label form-control-label ">
                        License Tax Due date </label>
                    <div class="col-md-7">

                        <input type="date" class="form-control  d-inline @error('dueDate') is-invalid @enderror"
                            id="dueDate" name="dueDate" value="{{old('dueDate',$license->due_date)}}"
                    ...
                    <input type="submit" id="register" value="Update" class="btn btn-primary col-md-2 mx-3 mt-3 mt-md-0"
                        onclick="javascript:event.preventDefault()" data-target="#confirm-update-license"
                        data-toggle="modal">
                </div>
            ...
            {{-- Confirmation modal for update license details--}}
            <div class=" modal fade" id="confirm-update-license" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Are you sure you wish to update License Tax details ?<br></p>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="redirect" class="btn  btn-primary ml-auto"
                                onclick="javascript:document.getElementById('update-license-details').submit();">{{__('menu.Yes')}}</button>
                        </div>
    ...
    <div class="mb-4 col-lg-10 col-sm-12">
        <div class="card shadow">
            ...
            <div class="card-header bg-white border-0">
                <div class="row align-items-center">
                    <div class="col-6 card-header">
                        <h3 class="mb-0">{{__('menu.Assessment Ranges of license Tax')}}</h3>
                    </div>
                    <div class="col-6 text-right">
                        {{-- {{$license->assessmentRanges->last()->start_value}} --}}
            ...
            <div class="table-responsive px-5" style="width:100%">
                ...
                <form action="{{route('license-add-range')}}" method="POST" id="assessment-range-form">
                    @csrf
                    <div class="row pb-2">
                        <div class="col-md-5">
                            <div class="form-group">
                                <input type="number" step="0.01" class="form-control"
                                    value="{{$license->assessmentRanges->last()->start_value}}" readonly
                                    name="oldLimit">
                            </div>
                        </div>
                        <div class="col-md-5">
                ...
                <table id="assessment_table" class="table">
                    ...
                    <tbody>
                        @foreach ($license->assessmentRanges as $range)
                        <tr>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        <a class="dropdown-item"
                                            href="{{route('view-license-range-types',['id'=>$range->id])}}">view
                                            types</a>
                                    </div>
                                </div>
                            </td>
