    ...
    <div class="card-body bg-secondary ">
        ...
        <form method="POST" action="{{route('update-club-licence-percentage')}}" id="update-club-licence-details">
            ...
            <div class="row">
                ...
                <div class="form-group row col-12 ">
                    <label for="example-text-input" class="col-md-2 col-form-label form-control-label ">
                        Club Licence Tax Due date </label>
                    <div class="col-md-7">

                        <input type="date" class="form-control  d-inline @error('dueDate') is-invalid @enderror"
                            id="dueDate" name="dueDate" value="{{old('dueDate',$clubLicence->due_date)}}"
                    ...
                    <input type="submit" id="register" value="Update" class="btn btn-primary col-md-2 mx-3 mt-3 mt-md-0"
                        onclick="javascript:event.preventDefault()" data-target="#confirm-update-club-licence"
                        data-toggle="modal">
                </div>
            ...
            <div class=" modal fade" id="confirm-update-club-licence" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Are you sure you wish to update Club Licence Tax details ?<br></p>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="redirect" class="btn  btn-primary ml-auto"
                                onclick="javascript:document.getElementById('update-club-licence-details').submit();">{{__('menu.Yes')}}</button>
                        </div>
