...
<div class="col-11 m-3 card shadow">
    <div class="card-header bg-transparent">
        <h3 class="mb-0"><span class="text-uppercase">Add Entertainment Tax Ticket Type</span></h3>
    </div>

    <div class="card-body bg-secondary ">
        <form method="POST" action="{{route('add-entertainment-ticket-type')}}" id="add-entertainment-type">
            @csrf
...
<div class="col-11 m-3 card shadow" id="update-type-card">
    <div class="card-header bg-transparent">
        <h3 class="mb-0"><span class="text-uppercase">Update Entertainment Tax Ticket Type</span></h3>
    </div>

    <div class="card-body bg-secondary ">
        <form method="POST" action="{{route('update-entertainment-ticket-type')}}" id="update-entertainment-type">
            @csrf
            @method('put')
        ...
        <div class="card shadow">
            <div class="card-header bg-white border-0">
                <div class="row align-item-center">
                    <div class="col">
                        <h3 class="mb-0">
                            <span class="text-uppercase">{{__('menu.Entertainment Ticket Types')}}</span>
                        </h3>
                        <hr class="mt-4 mb-0">
                    </div>
                </div>
                    ...
                    <table id="TicketTypesTable" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{number_format($type->vat_percentage,2)}}</td>
...
<script>
    $(document).ready(function() {
        ...
        $('.update-btn').on('click',function(){
                ...
                $('#update-percentage').val(ticketType.vat_percentage)
                $('html, body').animate({
